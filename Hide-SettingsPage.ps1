<#
.DESCRIPTION
    Hides a settings page in the settings application.
.PARAMETER SettingsPage
    Defines the settings page(s) that will be hidden in the settings application.
.PARAMETER Scope
...
.Example
    Hide-SettingsPage -SettingsPage WindowsUpdate
.NOTES
    Author: Michael Hollingsworth
#>
function Hide-SettingsPage {
    ...
    $spv.HiddenSettings += $SettingsPage
